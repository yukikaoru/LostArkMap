    ...
    LAM.updateData = {
        ...
        4: {
            ...
            e: [
                ...
                'Added 154 Cards in a new Cards Section (more data on them will come later)',
                'Added 16 Treasure Maps',
                'Added 2 Guides',
                'Added 3 FAQ Entries',
        ...
        12: {
            ...
            e: [
                'Added Peyton Maps',
                'Added Blue Wind Island, Gisbroy, Knut`s Tomb, Shadowmoon Market and Mureung Island',
                'Added Achievement, Essence, Ghost Ship Marker Type',
                'Added 6 Ghost Ships',
                'Added 14 Achievement Markers',
                'Added 15 Bosses',
                'Added 9 Hidden Quests',
                'Added 22 Hidden Stories',
                'Added 98 Mokoko Seeds',
